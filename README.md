...
```bash
  ...
  dotnet user-secrets set "TokenOptions:AccessTokenSecurityKey" "Your_Access_Token_Security_Key_Here"
  dotnet user-secrets set "TokenOptions:EmailConfirmationTokenSecurityKey" "Your_Email_Confirmation_Token_Security_Key_Here"
  dotnet user-secrets set "TokenOptions:PasswordResetTokenSecurityKey" "Your_Password_Reset_Token_Security_Key_Here"       

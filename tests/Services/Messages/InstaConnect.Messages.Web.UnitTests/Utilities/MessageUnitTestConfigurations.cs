...
public class MessageUnitTestConfigurations
{
    ...
    public const string EXISTING_MESSAGE_SENDER_NAME = nameof(EXISTING_MESSAGE_SENDER_NAME);
    public const string EXISTING_MESSAGE_SENDER_PROFILE_IMAGE = nameof(EXISTING_MESSAGE_SENDER_PROFILE_IMAGE);
    public const string EXISTING_MESSAGE_RECEIVER_ID = nameof(EXISTING_MESSAGE_RECEIVER_ID);
    public const string EXISTING_MESSAGE_RECEIVER_NAME = nameof(EXISTING_MESSAGE_RECEIVER_NAME);
    public const string EXISTING_MESSAGE_RECEIVER_PROFILE_IMAGE = nameof(EXISTING_MESSAGE_RECEIVER_PROFILE_IMAGE);

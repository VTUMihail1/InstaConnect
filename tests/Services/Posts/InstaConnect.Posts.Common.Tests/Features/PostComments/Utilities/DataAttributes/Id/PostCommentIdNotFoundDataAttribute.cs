...
public sealed class PostCommentIdNotFoundDataAttribute : LengthStringDataAttribute
{
    public PostCommentIdNotFoundDataAttribute()
        : base(PostCommentTestValueUtilities.IdAverage)
    {
    }
}

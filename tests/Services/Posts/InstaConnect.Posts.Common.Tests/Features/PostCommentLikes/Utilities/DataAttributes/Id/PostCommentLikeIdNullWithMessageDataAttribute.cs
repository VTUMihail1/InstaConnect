...
public sealed class PostCommentLikeIdNullWithMessageDataAttribute : NullStringWithMessageDataAttribute
{
    public PostCommentLikeIdNullWithMessageDataAttribute()

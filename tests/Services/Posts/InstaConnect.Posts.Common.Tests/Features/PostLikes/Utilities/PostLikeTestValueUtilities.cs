...
public static class PostLikeTestValueUtilities
{
    public static readonly int IdAverage = IntOperations.Average(PostLikeConfigurations.IdMaxLength, PostLikeConfigurations.IdMinLength);

...
public sealed class UserEmailNotFoundDataAttribute : LengthStringDataAttribute
{
    public UserEmailNotFoundDataAttribute()
        : base(UserTestValueUtilities.EmailAverage)
    {
    }
}

...
public static class UserTestValueUtilities
{
    ...
    public static readonly int NameAverage = IntOperations.Average(UserConfigurations.NameMaxLength, UserConfigurations.NameMinLength);
    ...
    public static readonly int EmailAverage = IntOperations.Average(UserConfigurations.EmailMaxLength, UserConfigurations.EmailMinLength);

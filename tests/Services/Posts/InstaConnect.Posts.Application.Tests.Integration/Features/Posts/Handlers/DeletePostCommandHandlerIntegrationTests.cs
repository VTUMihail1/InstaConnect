...
public class DeletePostCommandHandlerIntegrationTests : BasePostApplicationCommandIntegrationTest
{
	...
	public DeletePostCommandHandlerIntegrationTests(PostsWebApplicationFactory webApplicationFactory)

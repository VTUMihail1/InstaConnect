namespace InstaConnect.Posts.Application.Tests.Unit.Features.PostLikes.Handlers.GetById;

public class GetPostLikeByIdQueryRequestValidatorUnitTests : BasePostLikeApplicationQueryUnitTest
{

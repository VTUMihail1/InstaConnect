...
public class GetPostLikeByIdControllerIntegrationTests : BasePostLikePresentationQueryIntegrationTest
{
	...
	public GetPostLikeByIdControllerIntegrationTests(PostsWebApplicationFactory webApplicationFactory)

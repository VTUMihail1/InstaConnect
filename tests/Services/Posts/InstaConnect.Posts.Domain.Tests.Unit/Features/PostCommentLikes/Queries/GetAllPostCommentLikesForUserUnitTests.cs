...
namespace InstaConnect.Posts.Domain.Tests.Unit.Features.PostCommentLikes.Queries;

public class GetAllPostCommentLikesForUserUnitTests : BasePostCommentLikeDomainQueryUnitTest
{
	...
	public GetAllPostCommentLikesForUserUnitTests()
	{

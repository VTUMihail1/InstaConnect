...
public class GetAllPostCommentsIntegrationTests : BasePostCommentDomainQueryIntegrationTest
{
	...
	public GetAllPostCommentsIntegrationTests(PostsWebApplicationFactory webApplicationFactory)
		...
		IStringTransformer transformer)
	{
		...
		// Assert
		response.ShouldSatisfy(Post, PostComments, query);
	}
		...
		IEnumTransformer<CommonSortOrder> transformer, ISortEnumTermTransformer<PostComment> termTransformer)
	{
		...
		// Assert
		response.ShouldSatisfy(Post, PostComments, query, termTransformer);
	}

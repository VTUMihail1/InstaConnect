...
public class GetAllPostsForUserQueryServiceIntegrationTests : BasePostDomainQueryIntegrationTest
{
	...
	public GetAllPostsForUserQueryServiceIntegrationTests(PostsWebApplicationFactory webApplicationFactory)

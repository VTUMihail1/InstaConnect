...
public class GetPostByIdQueryServiceIntegrationTests : BasePostDomainQueryIntegrationTest
{
	...
	public GetPostByIdQueryServiceIntegrationTests(PostsWebApplicationFactory webApplicationFactory)

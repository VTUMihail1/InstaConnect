...
public class DeletePostCommandServiceIntegrationTests : BasePostDomainCommandIntegrationTest
{
	...
	public DeletePostCommandServiceIntegrationTests(PostsWebApplicationFactory webApplicationFactory)

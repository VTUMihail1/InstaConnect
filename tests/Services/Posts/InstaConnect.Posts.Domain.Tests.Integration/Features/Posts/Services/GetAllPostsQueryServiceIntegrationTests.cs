...
public class GetAllPostsQueryServiceIntegrationTests : BasePostDomainQueryIntegrationTest
{
	...
	public GetAllPostsQueryServiceIntegrationTests(PostsWebApplicationFactory webApplicationFactory)

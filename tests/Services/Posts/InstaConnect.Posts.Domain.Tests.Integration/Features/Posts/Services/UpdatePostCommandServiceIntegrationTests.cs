...
public class UpdatePostCommandServiceIntegrationTests : BasePostDomainCommandIntegrationTest
{
	...
	public UpdatePostCommandServiceIntegrationTests(PostsWebApplicationFactory webApplicationFactory)

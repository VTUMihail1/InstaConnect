...
public class GetAllPostLikesQueryServiceIntegrationTests : BasePostLikeDomainQueryIntegrationTest
{
	...
	public GetAllPostLikesQueryServiceIntegrationTests(PostsWebApplicationFactory webApplicationFactory)

...
public class GetPostLikeByIdQueryServiceIntegrationTests : BasePostLikeDomainQueryIntegrationTest
{
	...
	public GetPostLikeByIdQueryServiceIntegrationTests(PostsWebApplicationFactory webApplicationFactory)

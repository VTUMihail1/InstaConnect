...
namespace InstaConnect.Posts.Business.IntegrationTests.Features.Posts.Utilities;
...
public abstract class BasePostIntegrationTest : BaseSharedIntegrationTest, IClassFixture<IntegrationTestWebAppFactory>, IAsyncLifetime
{
        ...
        : base(integrationTestWebAppFactory.Services.CreateScope())
    {
        ...
        ValidAddTitle = GetAverageString(PostBusinessConfigurations.TITLE_MAX_LENGTH, PostBusinessConfigurations.TITLE_MIN_LENGTH);
        ValidUpdateTitle = GetAverageString(PostBusinessConfigurations.TITLE_MAX_LENGTH, PostBusinessConfigurations.TITLE_MIN_LENGTH);

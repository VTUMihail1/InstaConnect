...
public class GetAllChatMessagesIntegrationTests : BaseChatMessageDomainQueryIntegrationTest
{
	...
	public GetAllChatMessagesIntegrationTests(ChatsWebApplicationFactory webApplicationFactory)

...
public class AddChatCommandHandlerIntegrationTests : BaseChatApplicationCommandIntegrationTest
{
	...
	public AddChatCommandHandlerIntegrationTests(ChatsWebApplicationFactory webApplicationFactory)

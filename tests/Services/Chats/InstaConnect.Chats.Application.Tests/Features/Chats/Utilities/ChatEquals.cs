...
public static class ChatEquals
{
	...
	{
		public bool MatchesParticipantOne(AddChatCommandRequest request, User? entity)
		{
			return entity != null &&
		...
		public bool MatchesParticipantTwo(AddChatCommandRequest request, User? entity)
		{
			return entity != null &&

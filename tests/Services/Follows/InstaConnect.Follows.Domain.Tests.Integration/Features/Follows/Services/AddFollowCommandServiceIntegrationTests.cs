...
public class AddFollowCommandServiceIntegrationTests : BaseFollowDomainCommandIntegrationTest
{
	...
	public AddFollowCommandServiceIntegrationTests(FollowsWebApplicationFactory webApplicationFactory)

...
public class GetAllFollowsQueryServiceIntegrationTests : BaseFollowDomainQueryIntegrationTest
{
	...
	public GetAllFollowsQueryServiceIntegrationTests(FollowsWebApplicationFactory webApplicationFactory)

...
public class GetFollowByIdIntegrationTests : BaseFollowDomainQueryIntegrationTest
{
	...
	public GetFollowByIdIntegrationTests(FollowsWebApplicationFactory webApplicationFactory)

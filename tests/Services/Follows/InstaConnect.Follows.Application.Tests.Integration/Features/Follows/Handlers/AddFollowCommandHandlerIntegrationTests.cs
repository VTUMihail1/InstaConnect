...
public class AddFollowCommandHandlerIntegrationTests : BaseFollowApplicationCommandIntegrationTest
{
	...
	public AddFollowCommandHandlerIntegrationTests(FollowsWebApplicationFactory webApplicationFactory)

...
public class UserBuilder
{
    ...
    public UserBuilder()
    {
        ...
        _passwordHash = UserDataFaker.GetPasswordHash();
    ...
    public UserBuilder WithPasswordHash(IStringTransformer transformer)
    {
        _passwordHash = transformer.Transform(_passwordHash);

        return this;
    }

    public UserBuilder WithIsEmailConfirmed(IBooleanTransformer transformer)
    {
        _isEmailConfirmed = transformer.Transform(_isEmailConfirmed);

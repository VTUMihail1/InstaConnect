...
namespace InstaConnect.Identity.Domain.Tests.Integration.Features.UserClaims.Queries;

public class GetAllUserClaimsIntegrationTests : BaseUserClaimDomainQueryIntegrationTest
{
	...
	public GetAllUserClaimsIntegrationTests(IdentityWebApplicationFactory webApplicationFactory)

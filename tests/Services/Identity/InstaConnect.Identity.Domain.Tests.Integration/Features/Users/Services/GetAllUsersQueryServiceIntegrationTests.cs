...
public class GetAllUsersQueryServiceIntegrationTests : BaseUserDomainQueryIntegrationTest
{
	...
	public GetAllUsersQueryServiceIntegrationTests(IdentityWebApplicationFactory webApplicationFactory)

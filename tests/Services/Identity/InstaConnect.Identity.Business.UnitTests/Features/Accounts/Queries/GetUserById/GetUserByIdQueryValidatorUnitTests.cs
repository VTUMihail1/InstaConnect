...
namespace InstaConnect.Identity.Business.UnitTests.Features.Accounts.Queries.GetUserById;

public class GetUserByIdQueryValidatorUnitTests : BaseAccountUnitTest
{
    ...
    {
        // Arrange
        var query = new GetUserByIdQuery(Faker.Random.AlphaNumeric(length));

...
public static class Client
{
    ...
    public static async Task<HttpStatusCode> PostStatusCodeAsync<T>(this HttpClient httpClient, string route, T request, CancellationToken cancellationToken)
    {
    ...
    public static async Task<TResult> PostAsync<T, TResult>(this HttpClient httpClient, string route, T request, CancellationToken cancellationToken)
    {
        var responseMessage = await httpClient.PostAsJsonAsync(route, request, cancellationToken);
        var response = await responseMessage.Content.ReadFromJsonAsync<TResult>(cancellationToken);

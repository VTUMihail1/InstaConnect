namespace InstaConnect.Posts.Business.Features.PostComments.Utilities;

public class PostCommentBusinessConfigurations
{
    ...
    public const int CONTENT_MIN_LENGTH = 7;

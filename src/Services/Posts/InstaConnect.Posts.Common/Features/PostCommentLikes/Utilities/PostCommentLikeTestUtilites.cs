...
public class PostCommentLikeTestUtilities : SharedTestUtilities
{
    ...
    public static readonly string ValidPostCommentContent = GetAverageString(PostCommentConfigurations.ContentMaxLength, PostCommentConfigurations.ContentMinLength);
    public static readonly string InvalidUserId = GetAverageString(PostCommentLikeBusinessConfigurations.CURRENT_USER_ID_MAX_LENGTH, UserConfigurations.IdMinLength);
    public static readonly string ValidUserName = GetAverageString(PostCommentLikeBusinessConfigurations.CURRENT_USER_NAME_MAX_LENGTH, UserConfigurations.NameMinLength);
    public static readonly string ValidUserFirstName = GetAverageString(PostCommentLikeBusinessConfigurations.CURRENT_USER_NAME_MAX_LENGTH, UserConfigurations.NameMinLength);
    public static readonly string ValidUserLastName = GetAverageString(PostCommentLikeBusinessConfigurations.CURRENT_USER_NAME_MAX_LENGTH, UserConfigurations.NameMinLength);
    public static readonly string ValidUserEmail = GetAverageString(PostCommentLikeBusinessConfigurations.CURRENT_USER_NAME_MAX_LENGTH, UserConfigurations.NameMinLength);
    public static readonly string ValidUserProfileImage = GetAverageString(PostCommentLikeBusinessConfigurations.CURRENT_USER_NAME_MAX_LENGTH, UserConfigurations.NameMinLength);
    public static readonly string ValidCurrentUserId = GetAverageString(PostCommentLikeBusinessConfigurations.CURRENT_USER_ID_MAX_LENGTH, UserConfigurations.IdMinLength);

...
public static class PostCommentLikeQuerySql
{
    public const string GetAll = $@"SELECT 
                                       ...
                                       pcl.comment_like_id as {nameof(PostCommentLikeQueryEntity.CommentLikeId)}
                                   ...
                                   WHERE pcl.{nameof(PostCommentLikeQueryEntity.Id)} = @{nameof(GetPostCommentLikeByIdQueryParameters.Id)}
                                     ...
                                     AND pcl.{nameof(PostCommentLikeQueryEntity.UserId)} = @{nameof(GetAllPostCommentLikesQueryParameters.UserId)}
    ...
    public const string GetById = $@"SELECT
                                   ...
                                   WHERE pcl.{nameof(PostCommentLikeQueryEntity.Id)} = @{nameof(GetPostCommentLikeByIdQueryParameters.Id)}
                                     AND pcl.{nameof(PostCommentLikeQueryEntity.CommentId)} = @{nameof(GetPostCommentLikeByIdQueryParameters.CommentId)}
                                     AND pcl.{nameof(PostCommentLikeQueryEntity.CommentLikeId)} = @{nameof(GetPostCommentLikeByIdQueryParameters.CommentLikeId)};";

    public const string GetByIdAndUserId = $@"SELECT
                                       pcl.id AS {nameof(PostCommentLikeQueryEntity.Id)},
                                       pcl.comment_id AS {nameof(PostCommentLikeQueryEntity.CommentId)},
                                       pcl.comment_like_id as {nameof(PostCommentLikeQueryEntity.CommentLikeId)}
                                       pcl.user_id AS {nameof(PostCommentLikeQueryEntity.UserId)},
                                   ...
                                   FROM post_comment_likes pcl
                                   INNER JOIN users u ON pcl.{nameof(PostCommentLikeQueryEntity.UserId)} = u.{nameof(UserQueryEntity.Id)}
                                   WHERE pcl.{nameof(PostCommentLikeQueryEntity.Id)} = @{nameof(GetPostCommentLikeByIdAndUserIdQueryParameters.Id)}
                                     AND pcl.{nameof(PostCommentLikeQueryEntity.CommentId)} = @{nameof(GetPostCommentLikeByIdAndUserIdQueryParameters.CommentId)}
                                     AND pcl.{nameof(PostCommentLikeQueryEntity.UserId)} = @{nameof(GetPostCommentLikeByIdAndUserIdQueryParameters.UserId)};";
}

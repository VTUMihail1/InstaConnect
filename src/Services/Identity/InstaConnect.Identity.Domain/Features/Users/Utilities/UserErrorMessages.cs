...
public static class UserErrorMessages
{
    ...
    public static string GetPasswordTooShort(int length)
    {
        ...
        return Format.FormatInvariantCulture(length, UserConfigurations.PasswordMinLength);
    }
    ...
    public static string GetPasswordTooLong(int length)
    {
        ...
        return Format.FormatInvariantCulture(length, UserConfigurations.PasswordMaxLength);
    }
    ...
    public static string GetPageTooSmall(int page)
    {
        ...
        var result = Format.FormatInvariantCulture(page, UserConfigurations.PageMinValue);
    ...
    public static string GetPageTooLarge(int page)
    {
        ...
        var result = Format.FormatInvariantCulture(page, UserConfigurations.PageMaxValue);
    ...
    public static string GetPageSizeTooSmall(int pageSize)
    {
        ...
        var result = Format.FormatInvariantCulture(pageSize, UserConfigurations.PageSizeMinValue);
    ...
    public static string GetPageSizeTooLarge(int pageSize)
    {
        ...
        var result = Format.FormatInvariantCulture(pageSize, UserConfigurations.PageSizeMaxValue);

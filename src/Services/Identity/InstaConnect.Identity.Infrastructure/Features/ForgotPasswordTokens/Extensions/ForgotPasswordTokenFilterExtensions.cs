...
{
    public static FilterDefinition<ForgotPasswordToken> GetFilter(this ForgotPasswordTokenId filter)
    {
        return filter.GetFilterForIdEquals<ForgotPasswordToken>(p => p.Id.Id.Id, p => p.Id.Value);
    }

    public static FilterDefinition<ForgotPasswordToken> GetFilter(this IEnumerable<ForgotPasswordTokenId> filter)
    {
    ...
    public static FilterDefinition<T> GetFilterForIdEquals<T>(
        this ForgotPasswordTokenId filter,
    ...
    public static FilterDefinition<T> GetFilterForIdIn<T>(
        this IEnumerable<ForgotPasswordTokenId> filter,
        Expression<Func<T, object>> idField,
        Expression<Func<T, object>> valueField)
    {
